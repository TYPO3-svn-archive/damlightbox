	...
	function nextEffect() {
		switch (state++) {					
			...
			case 3:
				...
				state++;
			case 4:
// schradt: add width otherwise captions bleeds over the edges
				bottomContainer.setStyles({top: top + center.clientHeight, width: center.style.width, marginLeft: center.style.marginLeft, visibility: "hidden", display: ""});
